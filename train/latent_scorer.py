...
kept, and the 3k pool's candidates are scored into a new cache directory with `latent_cos`.
    ...
    python3 train/latent_scorer.py --shards cache/latents --out_dir checkpoints/latent_scorer \
        --cache_in cache/train_3k --cache_out cache/train_3k_latent      # then train with --selector latent
"""
...
def main():
    ...
    ap.add_argument("--out_dir", default="checkpoints/latent_scorer")
    ap.add_argument("--cache_in", default="cache/train_3k")
    ap.add_argument("--cache_out", default="cache/train_3k_latent")
