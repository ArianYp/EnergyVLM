...
recomputed and checked against the cached `dino_patch_cos` (bf16 drift is ~2e-3).
    ...
    python3 data/build_latent_manifest.py --train_cache cache/train --test_cache cache/train_3k --out cache/latents/manifest.jsonl
    python3 data/build_latents.py --manifest cache/latents/manifest.jsonl --shard 0 --nshard 10 --out cache/latents/shard0.pt
"""
